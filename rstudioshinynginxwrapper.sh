...
sudo cp https://raw.githubusercontent.com/jtsmith275/RStudioShiny-nginx/master/default -O /etc/nginx/sites-enabled/default
...
sudo cp https://raw.githubusercontent.com/jtsmith275/RStudioShiny-nginx/master/defaultshiny-server.conf -O /etc/shiny-server/shiny-server.conf
